...
plot "smallpkl.data" using (($1)/1000):($4) title 'ProGReGA' with linespoints lt 7, "smallpkhkl.data" using (($1)/1000):($4) title 'ProGReGA-KH' with linespoints lt 7, "smallpkfkl.data" using (($1)/1000):($4) title 'ProGReGA-KF' with linespoints lt 7, "smallbfakl.data" using (($1)/1000):($4) title 'BFBCT' with linespoints lt 7, "smallahmed.data" using (($1)/1000):($4) title 'Ahmed' with linespoints lt 7
