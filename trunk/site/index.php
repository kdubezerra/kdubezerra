...
<script type="text/javascript">
  var hoje = new Date();	
  var ano = hoje.getYear(); if (ano < 2000) ano += 1900; //em alguns navegadores, 20xx é retornado como 1xx
  var mes = hoje.getMonth() + 1; //janeiro = 0 ... dezembro = 11 : melhor somar 1
  var diasRestantes = 0;

  if (ano == 2009 && mes == 10) {
    diasRestantes = 29 - hoje.getDate();
    if (diasRestantes < 0)
      diasRestantes = 0;
  }

  var imgUbuntu = document.getElementById('ubuntuCountDown');
  imgUbuntu.src = 'http://www.ubuntu.com/files/countdown/910/countdown-9.10-1/0' + diasRestantes + '.png';
  if (diasRestantes > 1) {
    imgUbuntu.alt = diasRestantes + ' days until Ubuntu 9.10!!!';
  } else if (diasRestantes == 1) {
    imgUbuntu.alt = diasRestantes + ' day until Ubuntu 9.10!!!';
  } else {
    imgUbuntu.alt = 'Ubuntu 9.10 Coming Soon!!!';
  }
</script>
-->
