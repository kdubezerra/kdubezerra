...
Em trabalhos como \cite{yu2007nas}, \cite{kim2005tcm} e \cite{svoboda2007taa}, é analisado o tráfego de rede gerado por jogos em larga escala. A partir destes trabalhos, foram decididos os seguinte parâmetros, que foram utilizados na simulação:
