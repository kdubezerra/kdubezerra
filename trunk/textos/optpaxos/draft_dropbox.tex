...
\WHEN{$am\_multicast \setminus am\_delivered \neq \emptyset$} \label{algline:inammulticast}
	\STATE let $m$ be the message in $am\_multicast \setminus am\_delivered$ with smallest timestamp
