...
set ylabel 'Upload bandwidth used by the server (kilobytes/s)'
#set xtics auto
#set ytics auto
set autoscale
set xtics (40,80,120,160)
set xrange [30:170]
set yrange [0:3.0e+04]
set grid
set key top left
set pointsize 1.5
#set key below
...
plot "bwdata.data" using 1:($5/(1024)) title 'Traditional server - maximum' with linespoints lt 7 pt 4, "bwdata.data" using 1:($4/(1024)) title 'Traditional server - average' with linespoints lt 7 pt 2, "bwdata.data" using 1:($3/(1024)) with linespoints title 'Proj48534 server - maximum' lt 7 pt 7, "bwdata.data" using 1:($2/(1024)) title 'Proj48534 server - average' with linespoints lt 7 pt 6
