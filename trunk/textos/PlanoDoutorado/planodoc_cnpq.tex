...
Por fim, houve contato também com o professor Fernando Pedone, da Universidade de Lugano (UNISI), na Suíça, que trabalha com sistemas distribuídos e sistemas de gerenciamento de dados distribuídos, sendo que também há grande interesse de ambas as instituições -- UFRGS e USI -- de haver cooperação neste projeto, por meio de um doutorado em regime de co-tutela.
...
O projeto dará continuidade a pesquisa anterior realizada pelo GPPD -- grupo de processamento paralelo e distribuído -- do PPGC/UFRGS. Esta pesquisa anterior resultou em um projeto com a FINEP e publicação de artigos em eventos nacionais e internacionais, dentre os quais podem ser citados:

\begin{itemize}

\item Artigos completos, em simpósios internacionais Qualis A e B:
...
\item Artigo completo, em simpósio nacional:
...
\textbf{A communication optimization for conservative interactive simulators}, CECIN, Fábio R.; BARBOSA, Jorge L. V.; GEYER, Cláudio F. R., em \emph{IEEE Communications Letters}, vol. 10, no. 9, setembro de 2006;
