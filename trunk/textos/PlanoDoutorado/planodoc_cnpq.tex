...
Será necessário um esquema de balanceamento de carga, baseado em particionamento de grafo e refinamento de suas partições \cite{kernighan1970ehp, karypis1999pmk, karypis1998mam, dutt1993nfk}. O mundo poderia seria dividido em células de mesmo tamanho e posição fixa, cada uma representada por um vértice em um grafo. A interação (medida em kilobytes por segundo) entre as células seriam representadas pelas arestas ligando os vértices. O algoritmo de balanceamento de carga consistiria no particionamento do grafo, sendo que cada partição representaria uma região. Cada região, por sua vez, seria distribuída entre um ou mais nodos servidores. Tal esquema de balaceamento de carga do sistema deverá levar em consideração essa distribuição em dois níveis. %Uma idéia seria a de usar apenas réplicas, com o intuito de prover tolerância a falhas na região. A carga dentro de uma região seria redistribuída apenas quando a mesma estivesse sobrecarregada e não fosse viável reparticioná-la.
...
Por fim, houve contato também com o professor Fernando Pedone, da Universidade de Lugano (USI), na Suíça, que trabalha com sistemas distribuídos e sistemas de gerenciamento de dados distribuídos, sendo que também há possibilidade de estágio no exterior nessa universidade.
