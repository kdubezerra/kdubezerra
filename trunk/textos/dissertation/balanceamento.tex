...
Por fim, há questões de menor importância, mas que também devem ser levadas em consideração. 

Não explicou direito o uso de grafos... introduzir a próxima seção (poe esse parágrafo antes ou depois da quebra de seção?)
