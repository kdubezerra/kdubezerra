...
%           \and
%           Clï¿½udio Fernando Resin Geyer \at
%           		Universidade Federal do Rio Grande do Sul \\
%              Av. Bento Gonï¿½alves, 9500, Porto Alegre, Brazil \\
%              Tel.: +55-51-99011155\\
...
\begin{abstract}
In a distributed MMOG massively multiplayer online game) server architecture, the server nodes may become easily overloaded by the high demand from the players for state updates. Many works propose algorithms to distribute 
%51
the load on the server nodes, but this load is usually defined as the number of players on each server, what is not an ideal measure. Also, the possible heterogeneity of the system is frequently overlooked. We propose a balancing scheme with two main goals: allocate load on server nodes proportionally to the each one's power and 
%111
reduce as much as possible the inter-server communication overhead, considering the load as the occupied bandwidth of each server. It is divided in three phases: local selection of servers, balancing and refinement. Four algorithms were proposed, from which \ggp\ is the best for overhead reduction and \ggpf\ is the most suited for reducing player migrations between servers. We also make a review of related works and some comparisons were made, where our approach performed better.
...
%[TODO:falar das prï¿½xima seï¿½ï¿½es]
...
%O balanceamento de carga entre servidores de jogos online maciï¿½amente multijogador ï¿½ fortemente dependente da distribuiï¿½ï¿½o dos avatares dos jogadores atravï¿½s do ambiente virtual. Alï¿½m disso, a depender da concentraï¿½ï¿½o de avatares, pode-se alternar entre uma funï¿½ï¿½o de crescimento de trï¿½fego linear e uma funï¿½ï¿½o quadrï¿½tica. Sendo assim, ï¿½ necessï¿½rio lidar com a localidade dos avatares, de maneira a otimizar o uso de largura de banda do sistema servidor, minimizando, tanto quanto possï¿½vel, o overhead causado pela comunicaï¿½ï¿½o entre jogadores ligados a servidores diferentes.
...
%
%[TODO:footnote?]Porï¿½m, o formato e a disposiï¿½ï¿½o destas cï¿½lulas irï¿½ influenciar no trï¿½fego gerado pelas mesmas entre os servidores. Por exemplo, um ambiente bidimensional poderia ser dividido em uma grade de cï¿½lulas quadradas. Neste caso, cada uma destas cï¿½lulas teria oito vizinhos, em mï¿½dia -- cï¿½lulas nas bordas do mapa poderiam ter cinco ou trï¿½s vizinhos apenas. Quanto mais servidores vizinhos, maior o trï¿½fego entre servidores, e maior o overhead causado por esta comunicaï¿½ï¿½o. A distribuiï¿½ï¿½o ideal, entï¿½o, seria utilizando cï¿½lulas hexagonais, cada uma com seis vizinhos. Estudos comprovam que esta ï¿½ a divisï¿½o em cï¿½lulas iguais que permite o menor nï¿½mero de vizinhos por cï¿½lula [TODO:ref]. Outra possibilidade seria utilizando fileiras alternadas de cï¿½lulas quadradas, onde cada fileira seria deslocada o equivalente ï¿½ metade do comprimento de uma cï¿½lula.
%
%[TODO:figura com diferentes tipos de divisï¿½o:sqr/hex/shift]
%
%**	
...
%[TODO: tirar todas as contraï¿½ï¿½es!]
...
%It is illustrated in [TODO: ref] in the grouping of these micro macrocï¿½lulas dynamics, which can adapt to the distribution of avatars.

%[TODO: figuraS com microcï¿½lulas e macrocï¿½lulas - fazer vetorial ou copiar? depende do tempo que tiver depois de terminar o texto. divisao em micro e agrupamento em macro]
...
%\label{sec:regselect}
%
%Um problema clï¿½ssico de alocaï¿½ï¿½o de tarefas em sistemas distribuï¿½dos ï¿½ o da dependï¿½ncia entre elas [TODO:refsDEdistGRAPH]. Tarefas dependentes entre si fazem com que os processadores nos quais elas estï¿½o sendo executadas tenham que se comunicar para que o processamento possa continuar. Isso gera dois problemas principais: em primeiro lugar, o processamento como um todo ï¿½ atrasado por causa do tempo de espera de cada transmissï¿½o e recebimento de mensagens -- supondo que a comunicaï¿½ï¿½o entre os processos seja por meio de mensagens, como ï¿½ o caso do MPI [TODO:ref].
%
%Para resolver este problema, sï¿½o utilizados grafos, da seguinte maneira: o conjunto de tarefas a realizar ï¿½ mapeado em um grafo com pesos. Cada vï¿½rtice representa uma tarefa e cada aresta representa a comunicaï¿½ï¿½o entre as tarefas. O peso de cada vï¿½rtice representa o custo de processamento e o peso da aresta a carga de comunicaï¿½ï¿½o. Para fazer a distribuiï¿½ï¿½o, ï¿½ feito um particionamento do grafo gerado. Cada partiï¿½ï¿½o terï¿½ um conjunto de tarefas que serï¿½o executadas no mesmo nodo e, conseqï¿½entemente, o atraso de comunicaï¿½ï¿½o entre elas serï¿½ relativamente pequeno [TODO:refbli]. No entanto, as arestas do grafo que ligam partiï¿½ï¿½es diferentes representam comunicaï¿½ï¿½o entre diferentes nodos. A Figura [TODO:ref] ilustra essa situaï¿½ï¿½o.
%
%[TODO:figura do grafo de tarefas e dependï¿½ncias, assim como particionamento com corte de arestas e diferentes particionamentos levando a diferentes cortes de aresta]
%
%Os algoritmos de particionamento do grafo de tarefas, geralmente, buscam atingir dois objetivos: gerar partiï¿½ï¿½es de peso aproximadamente igual, ou seja, cada nodo terï¿½ uma carga computacional semelhante ï¿½ dos outros; e minimizar o corte de aresta, ou seja, fazer com que a dependï¿½ncia entre os conjuntos de tarefas seja a menor possï¿½vel, reduzindo a comunicaï¿½ï¿½o entre os nodos de processamento. Por corte de aresta, entende-se o somatï¿½rio dos pesos de todas as arestas que ligam vï¿½rtices que estï¿½o em partiï¿½ï¿½es diferentes. [TODO:reffig]
%
%O problema de particionamento de grafos ï¿½ NP-completo [TODO:ref]. Contudo, jï¿½ foi feita bastante pesquisa nessa ï¿½rea, resultando em heurï¿½sticas que obtï¿½m boas soluï¿½ï¿½es, muitas vezes se aproximando de valores ï¿½timos [TODO:ref]. Uma das heurï¿½sticas mais conhecidas ï¿½ a de Kernighan e Lin \cite{kernighan1970ehp}, que tem como objetivo, partindo de duas partiï¿½ï¿½es iniciais quaisquer, chegar a duas partiï¿½ï¿½es com peso semelhante e corte de aresta reduzido. O algoritmo de Fiduccia e Mattheyses \cite{fiduccia1982lth} incrementa a soluï¿½ï¿½o de Kernighan e Lin, generalizando-a para hipergrafos, alï¿½m de permitir que cada partiï¿½ï¿½o tenha uma fraï¿½ï¿½o diferente do peso total do hipergrafo.
%
%Existem outros algoritmos mais recentes, como os baseados em divisï¿½o espectral [TODO:ref-33-e-20-karypisirreggraphs]. Este ï¿½ computacionalmente caro, por envolver complexos de ï¿½lgebra linear, precisando autovetor associado ao menor autovalor da matrix laplaciana associada ao grafo [TODO:ref]. No entanto, o particionamento resultante ï¿½ considerado excelente para uma vasta gama de problemas [TODO:ref]. Existe tambï¿½m a abordagem em vï¿½rios nï¿½veis [TODO:citemultilevel], atravï¿½s da simplifaï¿½ï¿½o do grafo por meio de contraï¿½ï¿½o dos mesmos e sobreposiï¿½ï¿½o das arestas correspondentes. Com o grafo mais simples, ï¿½ aplicado algum algoritmo de particionamente e entï¿½o ele se desdobra, jï¿½ particionado, atï¿½ o grafo original. Eventualmente, refinamentos no particionamento podem ser necessï¿½rios. Esta ï¿½ltima tï¿½cnica ï¿½ especialmente ï¿½til em grafos com grande nï¿½mero de vï¿½rtices, na ordem de centenas a milhares, ou mais. Na figura [TODO:ref] ï¿½ ilustrado esse particionamento em vï¿½rios nï¿½veis.
%
%[TODO:figura do multilevel]
%
%Contudo, MMOGs sï¿½o geralmente aplicaï¿½ï¿½es de tempo-real, alï¿½m de a carga imposta sobre os servidores mudar constantemente em tempo de execuï¿½ï¿½o. Por esse motivo, o algoritmo de particionamento utilizado deve ser rï¿½pido, tornando inviï¿½vel o uso da divisï¿½o espectral. ï¿½ proposto neste trabalho utilizar um algoritmo guloso, mais simples, definido em [TODO:aOUTRArefdekarypis], que pode nï¿½o atingir soluï¿½ï¿½es tï¿½o boas quanto as da divisï¿½o espectral, porï¿½m ï¿½ consideravelmente mais rï¿½pido. Alï¿½m disso, o custo para encontrar uma soluï¿½ï¿½o muito prï¿½xima do ï¿½timo nï¿½o se justifica no contexto de MMOGs, pelo fato dos pesos mudarem constantemente, precisando de um novo particionamento em relativamente pouco tempo. Jï¿½ quanto ao particionamento em vï¿½rios nï¿½veis, seu uso nï¿½o foi considerado necessï¿½rio pois o nï¿½mero de vï¿½rtices do grafo que representarï¿½ o ambiente virtual ï¿½ relativamente pequeno.
%
%%TODO:ver esse "definiï¿½ï¿½es e parametros"
%Nas prï¿½ximas seï¿½ï¿½es, serï¿½ apresentada a soluï¿½ï¿½o proposta neste trabalho para balanceamento de carga, comeï¿½ando pelas definiï¿½ï¿½es e parï¿½metros utilizados, assim como serï¿½ descrito como o problema foi mapeado para grafos e quais os objetivos e critï¿½rios do esquema proposto.
...
%TODO:definir um por um em detalhes, depois enumerï¿½-los no parï¿½grafo acima ^ para o leitor nï¿½o se perder
...
\begin{itemize}
	...
	%[TODO:ver se realmente precisa do item interaï¿½ï¿½o, ou se nao eh melhor usar relevancia mesmo]
...
%A escolha de cï¿½lulas para incluir na regiï¿½o busca fazer com que cada uma das arestas mais pesadas do grafo $GW$ ligue vï¿½rtices da mesma partiï¿½ï¿½o, reduzindo o corte de aresta e, assim, o overhead. A cada passo ï¿½ dada preferï¿½ncia a escolher a cï¿½lula livre que nï¿½o apenas seja vizinha de uma cï¿½lula jï¿½ presente na regiï¿½o, mas tambï¿½m cuja aresta ligando-as seja a mais pesada possï¿½vel. A Figura \ref{fig:ggp} mostra um exemplo dos passos do crescimento de uma regiï¿½o atï¿½ atingir a sua parcela de carga no balanceamento.
...
%[TODO: por desvantagens em outra seï¿½ï¿½o posteriores]
...
%definir cada caso da simulaï¿½ï¿½o e o porquï¿½ dele, em que influenciam os parametros e o que se quer tirar de conclusï¿½o
%mostrar quais parametros foram fixados em cada caso, o seu valor e o porquï¿½ destes para destes parï¿½metros terem sido fixados
%resultados: analisar, falar em ganhos em %, e buscar razï¿½es para estes ganhos/perdas.
%grï¿½ficos
%   I: migraï¿½ï¿½oXinstante, linhas, cada linha ï¿½ um tipo de balanceamento
%	 II: migraï¿½ï¿½oXtipo de balanceamento, barras empilhadas: barra de baixo: walk migrations; barra de cima: still migrations
...
% Nï¿½O ENTRA, ï¿½ DISPENSï¿½VEL E Nï¿½O ï¿½ BONITO OU SIMPLES DE FAZER (teria que ser um para cada tipo de balanceamento) -----> VI: weightXinstante (linhas: wtotal, w1, w2, ..., wnservs)
...
%% Use the relevant command to insert your figure file.
%% For example, with the graphicx package use
  \includegraphics[width=0.2\linewidth]{images/Fig-Geyer.jpg}

  \textbf{Cláudio Fernando Resin Geyer} is an associate professor at the Informatics Institute of the Federal University of Rio Grande do Sul. His research interests include massively multiplayer games, grid computing and ubiquitous computing. He received his Ph.D. in informatics from Joseph Fourier University. He is a member of ACM and of the Brazilian Computer Society.
