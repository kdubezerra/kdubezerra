...
set ylabel 'Desvio padr\343o do uso de recursos - {/Symbol s}(u(S))'
#set xtics auto
#set ytics auto
set autoscale
...
plot "smallpkl.data" using (($1)/1000):($4) title 'ProGReGA' with linespoints lt 7, "smallpkhkl.data" using (($1)/1000):($4) title 'ProGReGA-KH' with linespoints lt 7, "smallpkfkl.data" using (($1)/1000):($4) title 'ProGReGA-KF' with linespoints lt 7, "smallbfakl.data" using (($1)/1000):($4) title 'BFBCT' with linespoints lt 7
