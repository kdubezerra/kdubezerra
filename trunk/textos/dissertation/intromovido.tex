...
\begin{itemize}
 ...
 \item Criar um mecanismode distrbuição e de balanceamento dinâmico de carga que distribua a carga entre os nodos de maneira proporcional e justa, além de reduzir, tanto quanto possível e viável, o overhead causado pela própria distribuição.
\end{itemize}
