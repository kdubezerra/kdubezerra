...
#set title 'Overhead total para cada algoritmo ao longo do tempo (com hotspots)'
set xlabel 'Time (s)'
...
set output "overhead_hotspots.eps"
...
plot "smallkdth.data" using ($1 / 1000):($14 + $15 + $16 + $17 + $18 + $19 + $20 + $21) title 'KDTree' with linespoints lt 7, "smallbfh.data" using ($1 / 1000):($14 + $15 + $16 + $17 + $18 + $19 + $20 + $21) title 'BFBCT' with linespoints lt 7, "smallahmedh.data" using ($1 / 1000):($14 + $15 + $16 + $17 + $18 + $19 + $20 + $21) title 'Ahmed' with linespoints lt 7, "smallprh.data" using ($1 / 1000):($14 + $15 + $16 + $17 + $18 + $19 + $20 + $21) with linespoints title 'Progrega' lt 7
