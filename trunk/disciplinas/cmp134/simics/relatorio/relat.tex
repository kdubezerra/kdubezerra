...
\begin{figure}[!h]
  \centering  
  \includegraphics[width=\linewidth]{../arq_L123.png}
...
\begin{figure}[!h]
  \centering  
  \includegraphics[width=\linewidth]{../arq_L1234.png}
...
\begin{itemize}
 \item com outra arquitetura, na qual cada módulo de cache L2 pode ter uma ou duas memórias L3 no nível inferior da hierarquia; além disso, a outra mudança com relação à arquitetura 
\end{itemize}
