...
matriz recursive_mult (matriz A, matriz B) {
	...
	if ( ordem > MIN_RANK ) {
		...
		matriz M_111 = recursive_mult (A_11, B_11);
		matriz M_112 = recursive_mult (A_12, B_21);
		matriz M_121 = recursive_mult (A_11, B_12);
		matriz M_122 = recursive_mult (A_12, B_22);
		matriz M_211 = recursive_mult (A_21, B_11);
		matriz M_212 = recursive_mult (A_22, B_21);
		matriz M_221 = recursive_mult (A_21, B_12);
		matriz M_222 = recursive_mult (A_22, B_12);
