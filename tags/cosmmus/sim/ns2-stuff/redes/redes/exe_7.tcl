...
$ns duplex-link $t2 $a1 0.5Mb 1ms DropTail
...
$ns duplex-link $a1 $a2 0.5Mb 1ms DropTail
...
$ns duplex-link $a2 $r2 0.5Mb 1ms DropTail
...
set udp_2 [new Application/Traffic/CBR]
