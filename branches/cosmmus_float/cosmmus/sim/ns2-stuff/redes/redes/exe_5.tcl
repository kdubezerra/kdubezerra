...
$ns duplex-link $t1 $a1 2Mb 200ms DropTail
$ns duplex-link $t2 $a1 2Mb 200ms DropTail
$ns duplex-link $t3 $a1 2Mb 200ms DropTail
$ns duplex-link $t4 $a1 2Mb 200ms DropTail
...
$ns duplex-link $a1 $a2 1Mb 200ms DropTail
$ns duplex-link $a2 $a3 0.5Mb 200ms DropTail
$ns duplex-link $a3 $a4 0.1Mb 200ms DropTail
...
$ns duplex-link $a1 $r1 2Mb 200ms DropTail
$ns duplex-link $a2 $r2 1Mb 200ms DropTail
$ns duplex-link $a3 $r3 0.5Mb 200ms DropTail
$ns duplex-link $a4 $r4 0.1Mb 200ms DropTail
