...
set output "usagedeviation_uniform.eps"
...
plot "smallkdtu.data" using (($1)/1000):($4) title 'KDTree' with linespoints lt 7, "smallbfu.data" using (($1)/1000):($4) title 'BFBCT' with linespoints lt 7, "smallahmedu.data" using (($1)/1000):($4) title 'Ahmed' with linespoints lt 7, "smallpru.data" using (($1)/1000):($4) title 'Progrega' with linespoints lt 7
