//O programa ap2_ex2.c efetua uma sequência de débitos e créditos. Considerando os possíveis problemas causados pela concorrência apresentados em aula responda:

// O programa apresenta algum problema relacionado a concorrência? Qual? 
//   O programa apresenta o problema de concorrencia para uso de uma variavel. Nesse caso as threads estão querendo acessar a variavel saldo, então temos que restringir o acesso a essa variavel. É uma seção critica.

//Caso tenha algum problema, apresente uma nova versão do programa, com o problema solucionado
