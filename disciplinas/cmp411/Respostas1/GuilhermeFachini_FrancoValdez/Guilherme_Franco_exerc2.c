...
*
* O programa apresenta problema relacionado ao acesso a variável saldo, pois não há nada gerenciando a manipulação dessa variável, então, ela é incrementada ou *decrementada de qualquer maneira.
*/
