...
plot "bwdata.data" using 1:($8/(1024)) title 'Traditional server - average' with linespoints lt 7 pt 2, "bwdata.data" using 1:($9/(1024)) title 'Traditional server - maximum' with linespoints lt 7 pt 4, "bwdata.data" using 1:($6/(1024)) title 'P2PSE server - average' with linespoints lt 7 pt 6, "bwdata.data" using 1:($7/(1024)) with linespoints title 'P2PSE server - maximum' lt 7 pt 7
