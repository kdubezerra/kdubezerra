...
plot "bwdata.data" using 1:($4/(1024)) title 'Traditional server - average' with linespoints lt 7 pt 2, "bwdata.data" using 1:($5/(1024)) title 'Traditional server - maximum' with linespoints lt 7 pt 4, "bwdata.data" using 1:($2/(1024)) title 'P2PSE server - average' with linespoints lt 7 pt 6, "bwdata.data" using 1:($3/(1024)) with linespoints title 'P2PSE server - maximum' lt 7 pt 7
