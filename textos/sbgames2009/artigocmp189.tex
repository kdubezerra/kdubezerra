...
Para fazer uma divisão inicial do espaço, é construída uma kd-tree balanceada (tanto quanto possível, pois depende do número de servidores -- ou nós folha -- ser igual a uma potência de 2). Para isto, foi utilizada a função recursiva exibida no Algoritmo \ref{alg:buildtree} para a criação da árvore.
