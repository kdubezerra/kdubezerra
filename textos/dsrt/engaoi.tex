...
Regarding the proposed algorithm, \malg, it has been obtained an upload bandwidth usage reduction of 63.51\% and 33.58\%, respectively compared to the circular area of interest and the field of view based algorithms. The maximum upload bandwidth usage was also reduced, decreasing 63.51\% and 33.58\%, comparing to the same algorithms. Table \ref{tab_summary} shows the percentage of economy-wide average, maximum and average banda with the algorithm \ malg compared with other algorithms presented.
