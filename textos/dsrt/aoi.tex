...
\begin{itemize}
 ...
 \item Área próxima, para evitar que ocorram problemas caso o jogador faça seu avatar girar ao redor do próprio eixo muito rapidamente, além de melhorar a qualidade do jogo nessa área mais próxima. %explicar melhor
 \item Atenuação da freqüência de atualizações.
\end{itemize}

A área de interesse resultante então toma a forma de um setor de círculo, cuja origem é o centro de um círculo menor. Este círculo menor é a área próxima do avatar, que receberá atualizações de estado com intervalo normal de entidades que nela estiverem. 
