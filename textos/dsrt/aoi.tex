...
Nas sessões seguintes, serão descritos algumas versões desta técnica, sendo sendo o último o algoritmo que está sendo proposto neste trabalho.
...
\subsection{Ângulo de visão - REVER\%}
\label{angle}
