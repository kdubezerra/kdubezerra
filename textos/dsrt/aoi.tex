...
\begin{algorithmic}
 ...
 \IF{$dist \le CRITICAL\_DISTANCE$}
 \STATE $relevance \Leftarrow 1$
 \ELSE
 \IF{A can see E in its field of view}
 \STATE $relevance \Leftarrow 1 - \frac{dist}{VIEW\_DISTANCE}$
 \IF{$relevance < 0$}
...
Para simular a técnica proposta, foi utilizado o simulador de rede ns-2 \cite{mccanne:nsn}.
