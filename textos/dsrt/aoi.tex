...
\begin{itemize}
 \item Ângulo de visão do avatar, para determinar quais entidades o jogador tem que ser capaz de perceber imediatamente, por estarem à sua frente;
 ...
 melhorar a qualidade do jogo no espaço mais perto do avatar; %explicar melhor
...
Na figura \ref{fcsmooth}...

%figura
\label{fcsmooth}

Para contornar este problema, sugere-se considerar a região próxima ao avatar, que pode ser definida como um círculo menor, cuja área será unida à do setor de círculo que determina o campo de visão do jogador.
