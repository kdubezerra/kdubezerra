...
set ylabel 'Average bandwidth per client (bytes/s)'
#set xtics auto
#set ytics auto
set autoscale
...
plot "avg.data" using 1:($2/(2)) title 'No interest management' with linespoints lt 7, "avg.data" using 1:($3/(2)) title 'Circle' with linespoints lt 7, "avg.data" using 1:($4/(2)) title 'Circle with attenuation' with linespoints lt 7, "avg.data" using 1:($5/(2)) with linespoints title 'Field of View' lt 7, "avg.data" using 1:($6/(2)) with linespoints title 'A^3' lt 7
