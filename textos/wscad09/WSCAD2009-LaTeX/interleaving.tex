...
\title{Um Estudo da Adição de um Quarto\\ Nível de Cache em Processadores Multicore}

\author{Carlos Eduardo B. Bezerra$^{1}$, Cláudio F. R. Geyer$^{2}$\\
...
\begin{itemize}
 ...
 \item Número de instruções executadas pelo processador -- no Simics, é utilizado para este valor o termo \emph{steps}, que também será usado no texto daqui por diante;
...
\begin{figure}[!h]
  ...
  \caption{Números de steps necessários para executar o BT}
  \label{steps_bt}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption{Números de steps necessários para executar o CG}
  \label{steps_cg}
\end{figure}
