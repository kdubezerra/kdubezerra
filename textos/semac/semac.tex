...
%\title{Suporte a jogos maciçamente multijogador em cenários com recursos limitados}
\title{A novell area of interest technique for bandwidth usage optimization in distributed simulations}
