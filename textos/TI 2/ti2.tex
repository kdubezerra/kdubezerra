...
%
\documentclass[ti,english]{iiufrgs}
...
\title{Load Balancing Techniques for MMOG Multiserver Systems}
...
\begin{listofabbrv}{SPMDAAAA}
				 ...
				 \item[MMG] Massively multiplayer games
				 \item[MMORPG] Massively multiplayer online role-playing games
				 \item[DVE] Distributed Virtual Environment
...
\include{texto/00-abstract}
\include{texto/01-introduction}
\include{texto/02-ahmed2008mol}
\include{texto/03-bezerra2009lbs}
\include{texto/04-bezerra2009fgl}
\include{texto/05-bsptree}
\include{texto/06-conclusion}
\include{texto/conclusao} %propor na conclusão mesmo, se ficar muito pequeno
