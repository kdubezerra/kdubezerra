...
Jogos online maciçamente multijogador -- ou MMOGs, \emph{massively multiplayer online games} -- são o tema central deste plano de doutorado. Geralmente, utiliza-se uma infra-estrutura cliente-servidor para dar suporte a este tipo de jogo. Neste plano será proposto um modelo de distribuição do lado servidor, de maneira a reduzir seu custo de manutenção. Nas próximas seções será apresentado o contexto referente a jogos multijogador e MMOGs.
