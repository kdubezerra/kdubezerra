...
\begin{enumerate}
\item Revalidar os créditos obtidos durante o curso de mestrado acadêmico no Programa de Pós Graduação em Computação do Instituto de Informática da UFRGS (PPGC/UFRGS), cuja redação da dissertação encontra-se em andamento. As disciplinas cursadas e suas informações estão sumarizadas na Tabela \ref{revalidar};
\end{enumerate}
...
CMP139   & Tolerância a Falhas em Sistemas Distribuídos   & 4        \\ \hline
CMP255   & Prog. Paralela para Processamento de Alto Desempenho    & 4        \\ \hline
CMP167   & Programação com Objetos Distribuídos B       & 4        \\ \hline
CMP256   & Proj. de Prog. Paralelos para Proc. de Alto Desempenho & 4        \\ \hline
CMP157   & Programação Paralela e Distribuída & 4        \\ \hline
CMP250   & Aspectos Conceituais de Tolerância a Falhas & 1        \\ \hline
CMP401   & Trabalho Individual I         & 2        \\ \hline
