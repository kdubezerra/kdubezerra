...
%TODO: refs.
Diversos propostas já foram realizados com o intuito de fazer filtragem por interesse \cite{bezerra2008a3, ahmed2008dai, morgan2005imm, minson2005aim}. Além de investigar qual é a que melhor se aplica ao modelo proposto, e de verificar possíveis adaptações que sejam necessárias, outras maneiras de economizar os recursos do sistema servidor serão estudadas.
%dewan, eu, etc...
...
Este capítulo do tem como propósito detalhar os passos que vão se seguir para atingir os objetivos definidos anteriormente, que são a metodologia pretendida, os planos de cooperação internacional para este projeto e o cronograma das atividades a realizar.
...
\textbf{P2PSE - peer-to-peer software entertainment}: este projeto  foi iniciado no final de 2005, com a submissão de uma proposta e solicitação de recursos para edital CT-INFO da FINEP. O projeto FINEP foi aprovado e envolveu quatro professores da UFRGS (Cláudio Geyer - coordenador, Raul Weber, Luis Otávio Álvares e Dante Barone), um professor na UFSC (Rômulo Oliveira) e a empresa de desenvolvimento de jogos Singular Studios, de Porto Alegre, tendo sido concluído com êxito em agosto de 2008.

\end{itemize}

Este projeto, além de atingir os objetivos científicos descritos, visa à publicação dos trabalhos realizados na forma de artigos em conferências de âmbito nacional e internacional, de forma a divulgar os resultados obtidos.
