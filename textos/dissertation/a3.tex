...
\begin{figure}[!t]
	...
	\includegraphics[width=0.9\linewidth]{images/part}
...
\begin{figure}[!t]
	\centering
	%\includegraphics[width=2.5in]{max}
	\includegraphics[width=0.9\linewidth]{images/circle}
...
\begin{figure}[!t]
	\centering
	%\includegraphics[width=2.5in]{max}
	\includegraphics[width=0.9\linewidth]{images/fov}
...
\begin{figure}[!t]
	\centering
	%\includegraphics[width=2.5in]{max}
	\includegraphics[width=0.9\linewidth]{images/gcircle}
...
\begin{figure}[!t]
	\centering
	%\includegraphics[width=2.5in]{max}
	\includegraphics[width=0.9\linewidth]{images/a3}
...
\begin{figure}[!t]
	\centering
	%\includegraphics[width=2.5in]{max}
	\includegraphics[width=0.9\linewidth]{images/max}
...
\begin{figure}[!t]
  ...
  %\includegraphics[width=2.5in]{avg}
	\includegraphics[width=0.9\linewidth]{images/avg}
