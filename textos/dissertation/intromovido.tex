...
Através de simulações em software, como será mostrado ao longo do texto, demons{\-}trou-se que tais objetivos foram alcançados -- para jogos em que existe informação de localização das entidades do jogo no ambiente virtual --, validando as propostas apresentadas aqui.
