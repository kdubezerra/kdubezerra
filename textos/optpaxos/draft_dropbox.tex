...
\blankline
\INDENT{\textbf{when} deciding a message $m$}
...
\blankline
\INDENT{\textbf{when} $\exists h: g \in sendersTo(h) \wedge getTime() - lastBarrierCreated(h) > barrierThreshold$}
